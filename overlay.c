...
VkSemaphore submit_overlay(struct overlay_settings *settings,
  ...
  if (nk_begin(ctx, "Demo", nk_rect(50, 50, 230, 250),
    ...
    if (nk_option_label(ctx, "up", settings->direction == OVERLAY_DIRECTION_UP))
      settings->direction = OVERLAY_DIRECTION_UP;
    if (nk_option_label(ctx, "down", settings->direction == OVERLAY_DIRECTION_DOWN))
      settings->direction = OVERLAY_DIRECTION_DOWN;
